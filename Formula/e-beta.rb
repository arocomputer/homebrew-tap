class EBeta < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/arocomputer/e-beta/releases/download/v0.0.1-beta.9.gd2b45315c43c/e-aarch64-apple-darwin.tar.gz"
      sha256 "5b1981f589cba689b30d1458320e84c714beaac902c058506f716bd3bcd0fe3b"
    end
    on_intel do
      url "https://github.com/arocomputer/e-beta/releases/download/v0.0.1-beta.9.gd2b45315c43c/e-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/arocomputer/e-beta/releases/download/v0.0.1-beta.9.gd2b45315c43c/e-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "b6e1471858ea2d1146f7a37220b0c1d325555b85b204d63143d3078504617494"
    end
    on_intel do
      url "https://github.com/arocomputer/e-beta/releases/download/v0.0.1-beta.9.gd2b45315c43c/e-x86_64-unknown-linux-gnu.tar.gz"
